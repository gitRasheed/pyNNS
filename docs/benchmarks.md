...
These benchmarks use a local daily-return fixture at
`tests/fixtures/finance/sp500_daily_returns_2019_2023.csv`. That fixture is not
tracked in git. The latest recorded run used 1257 daily return rows and 480
clean return columns after dropping
